...
var Canvas = require('achart-canvas'),
    ...
    Candlestick = require('../src/candlestick'),
...
describe('candlestick 生成',function() {
    ...
    var plotRange = new PlotRange({x : 50,y : 400}, {x : 850, y : 50}),
        xAxis = canvas.addGroup(Axis.Time,{
            ...
            startDate : 1317888000000,
            tickInterval : 1317888060000 - 1317888000000,
            endDate : 1317899520000
        });
    ...
    it('生成',function(){
        series  = canvas.addGroup(Series.Candlestick, {
            xAxis: xAxis,
            yAxis: yAxis,
            labels: {
                label: {
