(function() {
  ...
  define("achart-stock/1.0.0/astock-debug", [], function(require, exports, module) {
    var astock = require("achart-stock/1.0.0/src/stock-debug");
    window.AStock = astock;
    module.exports = astock;
  });
  define("achart-stock/1.0.0/src/stock-debug", [], function(require, exports, module) {
    var Chart = require("acharts/1.0.5/acharts-debug"), //window.AChart,
      Util = Chart.Util,
      Theme = Chart.Theme;
    Theme.rangeSelector = {
      tooltip: null,
    ...
    Util.augment(Stock, {
      ...
      _renderScrollGroup: function() {
        ...
        //滑动条的两个button
        var path = 'M' + (margin - 15 + 8) + ',45L' + (margin - 15 + 6) + ',47' + 'L' + (margin - 15 + 8) + ',49' + 'L' + (margin - 15 + 8) + ',45z';
        scrollGroup.addShape('path', {
          path: path,
          stroke: "#000",
          fill: '#000'
        ...
        var path = 'M' + (width - margin + 7) + ',45L' + (width - margin + 9) + ',47' + 'L' + (width - margin + 7) + ',49' + 'L' + (width - margin + 7) + ',45z';
        scrollGroup.addShape('path', {
          path: path,
          stroke: "#000",
          fill: '#000'
        ...
        var path = 'M' + (width / 2 - 3) + ',44L' + (width / 2 - 3) + ',49' + 'M' + (width / 2) + ',44L' + (width / 2) + ',49' + 'M' + (width / 2 + 3) + ',44L' + (width / 2 + 3) + ',49';
  ...
  require("achart-stock/1.0.0/astock-debug");
})();