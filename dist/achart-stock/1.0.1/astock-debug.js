...
(function() {
  ...
  achart_util_100_src_util_debug = function(exports) {
    var Raphael = achart_raphael_100_index_debug,
      STEP_MS = 16,
      HANDLERS = {},
      TIMES = {},
      NAN = NaN,
  ...
  achart_canvas_100_src_raphealgroup_debug = function() {
    var Util = achart_util_100_index_debug,
      R = achart_raphael_100_index_debug;
    R.fn.group = function() {
  ...
  achart_axis_100_src_auto_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      DateUtil = achart_date_100_index_debug,
      snapArray = [
        0,
        1,
        1.5,
  ...
  achart_canvas_100_src_shape_debug = function(exports) {
    var Base = achart_canvas_100_src_base_debug,
      Item = achart_canvas_100_src_canvasitem_debug,
  ...
  achart_canvas_100_src_container_debug = function(exports) {
    var Shape = achart_canvas_100_src_shape_debug,
      Base = achart_canvas_100_src_base_debug,
      Util = achart_util_100_index_debug;
  ...
  achart_canvas_100_src_group_debug = function(exports) {
    var Container = achart_canvas_100_src_container_debug,
      Item = achart_canvas_100_src_canvasitem_debug,
      Util = achart_util_100_index_debug,
      Shape = achart_canvas_100_src_shape_debug;
  ...
  achart_canvas_100_src_canvas_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Group = achart_canvas_100_src_group_debug,
      Raphael = achart_raphael_100_index_debug,
      Container = achart_canvas_100_src_container_debug;
    ...
    Util.augment(Canvas, {
      ...
      getPoint: function(clientX, clientY) {
        ...
        if (!viewbox) {
          ...
          var xfactor = viewbox.width / _self.get('width'),
            yfactor = viewbox.height / _self.get('height');
  ...
  achart_plot_100_src_plotback_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      PlotItem = achart_plot_100_src_plotitem_debug,
      PlotRange = achart_plot_100_src_plotrange_debug;
  ...
  achart_axis_100_src_grid_debug = function(exports) {
    var Item = achart_plot_100_index_debug.Item,
      Util = achart_util_100_index_debug,
  ...
  achart_labels_100_src_showlabels_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Labels = achart_labels_100_src_labels_debug;
  ...
  achart_legend_101_src_legend_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      PlotItem = achart_plot_100_index_debug.Item,
      Item = achart_legend_101_src_legenditem_debug,
      LINE_HEIGHT = 15,
      PADDING = 5;
          ...
          _self.on('click', function(ev) {
            ...
            if (item) {
              ...
              if (checkable) {
                ...
                if (checked) {
                  _self.fire('itemunchecked', {
                    item: item
                  });
                } else {
                  _self.fire('itemchecked', {
                    item: item
                  });
                }
              }
  ...
  achart_legend_101_src_uselegend_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Legend = achart_legend_101_src_legend_debug;
  ...
  achart_flags_100_src_flags_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Flag = achart_flags_100_src_flag_debug,
      Group = achart_actived_100_index_debug.Group,
      PlotItem = achart_plot_100_index_debug.Item;
  ...
  achart_axis_100_src_abstract_debug = function(exports) {
    var Item = achart_plot_100_index_debug.Item,
      Grid = achart_axis_100_src_grid_debug,
      Util = achart_util_100_index_debug,
      ShowLabels = achart_labels_100_index_debug.ShowLabels,
  ...
  achart_axis_100_src_circle_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Abstract = achart_axis_100_src_abstract_debug;
    var RAD = Math.PI / 180;
  ...
  achart_series_100_src_base_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Item = achart_plot_100_index_debug.Item,
      ShowLabels = achart_labels_100_index_debug.ShowLabels,
      Actived = achart_actived_100_index_debug,
      Markers = achart_markers_100_index_debug;
  ...
  achart_series_100_src_cartesian_debug = function(exports) {
    var BaseSeries = achart_series_100_src_base_debug,
      Util = achart_util_100_index_debug;
  ...
  achart_series_100_src_line_debug = function(exports) {
    var Cartesian = achart_series_100_src_cartesian_debug,
      Util = achart_util_100_index_debug;
  ...
  achart_series_100_src_itemgroup_debug = function(exports) {
    var Base = achart_series_100_src_base_debug,
      Util = achart_util_100_index_debug;
  ...
  achart_series_100_src_area_debug = function(exports) {
    var Line = achart_series_100_src_line_debug,
      Util = achart_util_100_index_debug,
      Stacked = achart_series_100_src_stacked_debug,
      REGEX_MOVE = /^M.*(M).*$/;
    ...
    Util.augment(Area, {
      ...
      points2StackArea: function(points) {
        var _self = this,
          ...
          linePath, isInCircle = _self.isInCircle(),
          path = '',
          invert = _self.get('invert'),
          xName = _self.getXName(),
          yName = _self.getYName(),
      ...
      points2area: function(points) {
        var _self = this,
          ...
          linePath, invert = _self.get('invert'),
          xName = _self.getXName(),
          yName = _self.getYName(),
          path = '';
        if (length) {
  ...
  achart_series_100_src_pie_debug = function(exports) {
    var ItemGroup = achart_series_100_src_itemgroup_debug,
      ActiveGroup = achart_actived_100_index_debug.Group,
      Util = achart_util_100_index_debug,
      Legend = achart_legend_101_index_debug,
      Base = achart_series_100_src_base_debug;
    ...
    function alignLables(center, r, arr, endAngle, factor, lineHeight) {
      var count = parseInt(r * 2 / lineHeight, 10),
        maxY = center.y + r,
        minY = center.y - r,
      ...
      if (conflictIndex && conflictIndex < length - 1) {
    ...
    Util.augment(Pie, {
      ...
      lineToLabel: function(label, r, distance) {
        var _self = this,
          ...
          inner, lineHeight = _self.get('labelHeight'),
          lineGroup = _self.get('lineGroup'),
          path = [];
        if (label.angle == -90) {
  ...
  achart_axis_100_src_base_debug = function(exports) {
    var Abstract = achart_axis_100_src_abstract_debug,
      Util = achart_util_100_index_debug,
      CLS_AXIS = 'x-chart-axis';
    ...
    Util.augment(Axis, {
      ...
      getOffsetPoint: function(index, current) {
        var _self = this,
          ...
          indexCache = _self.get('indexCache');
        if (!current) {
  ...
  achart_axis_100_src_category_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Axis = achart_axis_100_src_base_debug;
    ...
    Util.augment(NumberAxis, {
      ...
      _setAutoOffset: function(info) {
        var _self = this,
          ...
          percentEnd = 0,
          offset = [],
          avg, append = _self.get('autoAppend'),
      ...
      getRelativeOffset: function(value) {
        var _self = this,
          ...
          tickInterval = _self.get('tickInterval'),
          count = ticks.length,
          floorVal, ceilingVal, baseVal, avg = _self._getAvgLength(ticks.length),
          offset;
        if (index !== -1) {
          return avg * index;
        }
  ...
  achart_axis_100_src_time_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      NAixs = achart_axis_100_src_number_debug;
  ...
  achart_series_100_src_column_debug = function(exports) {
    var Util = achart_util_100_index_debug,
      Cartesian = achart_series_100_src_cartesian_debug,
      ActiveGroup = achart_actived_100_index_debug.Group,
      Stacked = achart_series_100_src_stacked_debug,
      Group = achart_series_100_src_itemgroup_debug;
  ...
  achart_stock_101_src_candlestick_debug = function(exports) {
     ...
     *
     * */
    var AChart = acharts_1012_acharts_debug,
      //window.AChart,
  ...
  achart_stock_101_src_stock_debug = function(exports) {
    var Chart = acharts_1012_acharts_debug,
      Util = Chart.Util,
